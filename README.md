...
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,803 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,201 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,680 | 🐛 85 | 🌐 Shell | 📅 2026-09-07 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,684 | 🐛 160 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) ⭐ 4,673 | 🐛 30 | 🌐 Shell | 📅 2026-09-01 - A full-featured & carefully designed adaptive prompt for Bash & Zsh.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 910 | 🐛 9 | 🌐 Shell | 📅 2026-09-07 - Modern web framework in bash.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,172 | 🐛 42 | 🌐 Shell | 📅 2026-09-06 - A simple and extensible shell script for managing your todo.txt file.
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,002 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,040 | 🐛 93 | 🌐 Go | 📅 2026-09-06 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,397 | 🐛 8 | 🌐 Shell | 📅 2026-09-04 - 750+ DevOps Shell Scripts and Advanced Bash environment.
...
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,214 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 2 | 🌐 Shell | 📅 2026-09-07 - A simple testing library for bash scripts.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,207 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,657 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02.
