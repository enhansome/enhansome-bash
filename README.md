...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,671 | 🐛 186 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 18,031 | 🐛 7 | 🌐 Shell | 📅 2026-09-24 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,079 | 🐛 17 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 510,163 | 🐛 107 | 📅 2026-09-02.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,685 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,760 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 627 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for the bash shell.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 362 | 🐛 0 | 🌐 Shell | 📅 2026-09-25 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,715 | 🐛 162 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 917 | 🐛 9 | 🌐 Shell | 📅 2026-09-07 - Modern web framework in bash.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,177 | 🐛 43 | 🌐 Shell | 📅 2026-09-06 - A simple and extensible shell script for managing your todo.txt file.
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,249 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,085 | 🐛 94 | 🌐 Go | 📅 2026-09-22 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,419 | 🐛 8 | 🌐 Shell | 📅 2026-09-15 - 750+ DevOps Shell Scripts and Advanced Bash environment.
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,280 | 🐛 119 | 🌐 Shell | 📅 2026-09-23 - Bash Automated Testing System.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,454 | 🐛 2 | 🌐 Ruby | 📅 2026-08-24 - Bash command line framework and CLI generator.
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,217 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [modernish](https://github.com/modernish/modernish) ⭐ 942 | 🐛 8 | 🌐 Shell | 📅 2026-08-06 - Library with various features for shell scripting.
...
* [bash\_unit](https://github.com/pgrange/bash_unit) ⭐ 636 | 🐛 13 | 🌐 Shell | 📅 2026-02-11 -  Bash unit testing enterprise edition framework for professionals.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 430 | 🐛 0 | 🌐 Shell | 📅 2026-09-25 - A simple testing library for bash scripts.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,212 | 🐛 28 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,687 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
