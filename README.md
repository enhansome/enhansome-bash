...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,717 | 🐛 137 | 🌐 Rust | 📅 2026-08-19 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,627 | 🐛 82 | 🌐 Shell | 📅 2026-08-18 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,450 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Bash History Suggest Box.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,651 | 🐛 168 | 🌐 Shell | 📅 2026-08-01 - A delightful community-driven framework for managing your bash configuration.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,434 | 🐛 4 | 🌐 Ruby | 📅 2026-08-18 - Bash command line framework and CLI generator.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 0 | 🌐 Shell | 📅 2026-08-19 - A simple testing library for bash scripts.
