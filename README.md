...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,444 | 🐛 184 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,911 | 🐛 7 | 🌐 Shell | 📅 2026-08-13 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,045 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,489 | 🐛 99 | 📅 2026-06-30.
...
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,797 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,642 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,607 | 🐛 82 | 🌐 Shell | 📅 2026-08-11 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,307 | 🐛 26 | 🌐 Python | 📅 2026-04-15 - Bash history in the cloud. Indexed and searchable :cloud:.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 622 | 🐛 16 | 🌐 Rust | 📅 2024-10-28 - Contextual, dynamic, organized aliases for the bash shell.
* [sshrc](https://github.com/cdown/sshrc) ⭐ 528 | 🐛 4 | 🌐 Shell | 📅 2023-01-27 - Bring your .bashrc, .vimrc, etc. with you when you SSH.
* [utility-bash-scripts](https://github.com/aviaryan/utility-bash-scripts) ⭐ 472 | 🐛 6 | 🌐 Shell | 📅 2020-09-30 - Useful bash scripts to do automatable tasks with a single command.
* [commacd](https://github.com/shyiko/commacd) ⭐ 370 | 🐛 4 | 🌐 Shell | 📅 2019-11-07 - A faster way to move around in Bash.
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 360 | 🐛 0 | 🌐 Shell | 📅 2026-07-25 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
* [bashhub-server](https://github.com/nicksherron/bashhub-server) ⭐ 317 | 🐛 13 | 🌐 Go | 📅 2023-03-30 - Privately hosted open source bashhub server.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,636 | 🐛 170 | 🌐 Shell | 📅 2026-08-01 - A delightful community-driven framework for managing your bash configuration.
...
* [LS\_COLORS](https://github.com/trapd00r/LS_COLORS) ⭐ 2,275 | 🐛 8 | 🌐 Shell | 📅 2025-06-06 - A collection of LS\_COLORS definitions.
* [bash-sensible](https://github.com/mrzool/bash-sensible) ⭐ 2,123 | 🐛 10 | 🌐 Shell | 📅 2024-10-17 - An attempt at saner Bash defaults.
...
* [progress-bar.sh](https://github.com/edouard-lopez/progress-bar.sh) ⭐ 251 | 🐛 1 | 🌐 Shell | 📅 2025-10-24 - Simple & sexy progressbar for `bash`, give it a duration and it will do the rest.
* [aphrodite-terminal-theme](https://github.com/win0err/aphrodite-terminal-theme) ⭐ 177 | 🐛 2 | 🌐 Shell | 📅 2025-08-04 - Minimalistic theme (prompt) for sexy terminals.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 899 | 🐛 9 | 🌐 Shell | 📅 2025-09-06 - Modern web framework in bash.
* [balls](https://github.com/jneen/balls) ⭐ 869 | 🐛 5 | 🌐 Shell | 📅 2016-07-29 - Bash on Balls.
* [sherver](https://github.com/remileduc/sherver) ⭐ 351 | 🐛 2 | 🌐 Shell | 📅 2026-08-13 - Pure Bash lightweight web server.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,155 | 🐛 42 | 🌐 Shell | 📅 2026-08-13 - A simple and extensible shell script for managing your todo.txt file.
...
* [bpkg](https://github.com/bpkg/bpkg) ⭐ 1,973 | 🐛 38 | 🌐 Shell | 📅 2025-07-07 - A lightweight bash package manager.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,975 | 🐛 94 | 🌐 Go | 📅 2026-08-13 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,377 | 🐛 9 | 🌐 Shell | 📅 2026-08-05 - 750+ DevOps Shell Scripts and Advanced Bash environment.
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,210 | 🐛 123 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System.
* [Bash Infinity](https://github.com/niieani/bash-oo-framework) ⭐ 5,615 | 🐛 36 | 🌐 Shell | 📅 2023-12-15 - A modern boilerplate / framework / standard library for bash.
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,797 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - The corrective bash syntax highlighter.
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,433 | 🐛 3 | 🌐 Ruby | 📅 2026-07-09 - Bash command line framework and CLI generator.
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,211 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [modernish](https://github.com/modernish/modernish) ⭐ 937 | 🐛 8 | 🌐 Shell | 📅 2026-08-06 - Library with various features for shell scripting.
...
* [json.bash](https://github.com/h4l/json.bash) ⭐ 460 | 🐛 1 | 🌐 Shell | 📅 2024-12-08 - Bash library and command-line tool that creates JSON.
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 4 | 🌐 Shell | 📅 2026-08-14 - A simple testing library for bash scripts.
...
* [Bash Screensavers](https://github.com/attogram/bash-screensavers?) ⭐ 947 | 🐛 11 | 🌐 Shell | 📅 2026-07-23 - A collection of screensavers written entirely in bash.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,194 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,607 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02.
