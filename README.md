...
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,645 | 🐛 84 | 🌐 Shell | 📅 2026-08-18 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 360 | 🐛 0 | 🌐 Shell | 📅 2026-08-25 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,661 | 🐛 160 | 🌐 Shell | 📅 2026-08-21 - A delightful community-driven framework for managing your bash configuration.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,159 | 🐛 42 | 🌐 Shell | 📅 2026-08-24 - A simple and extensible shell script for managing your todo.txt file.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,007 | 🐛 95 | 🌐 Go | 📅 2026-08-23 - Format bash programs.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 0 | 🌐 Shell | 📅 2026-08-25 - A simple testing library for bash scripts.
