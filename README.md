...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,525 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,736 | 🐛 84 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 624 | 🐛 16 | 🌐 Rust | 📅 2026-09-17 - Contextual, dynamic, organized aliases for the bash shell.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 361 | 🐛 0 | 🌐 Shell | 📅 2026-09-17 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,707 | 🐛 161 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) ⭐ 4,677 | 🐛 29 | 🌐 Shell | 📅 2026-09-13 - A full-featured & carefully designed adaptive prompt for Bash & Zsh.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 913 | 🐛 9 | 🌐 Shell | 📅 2026-09-07 - Modern web framework in bash.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,062 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,412 | 🐛 8 | 🌐 Shell | 📅 2026-09-15 - 750+ DevOps Shell Scripts and Advanced Bash environment.
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,265 | 🐛 127 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,449 | 🐛 2 | 🌐 Ruby | 📅 2026-08-24 - Bash command line framework and CLI generator.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 427 | 🐛 0 | 🌐 Shell | 📅 2026-09-17 - A simple testing library for bash scripts.
