...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,457 | 🐛 184 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,926 | 🐛 6 | 🌐 Shell | 📅 2026-08-14 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,047 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 496,206 | 🐛 100 | 📅 2026-06-30.
...
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,796 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,664 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,615 | 🐛 82 | 🌐 Shell | 📅 2026-08-11 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,640 | 🐛 170 | 🌐 Shell | 📅 2026-08-01 - A delightful community-driven framework for managing your bash configuration.
...
* [sherver](https://github.com/remileduc/sherver) ⭐ 352 | 🐛 1 | 🌐 Shell | 📅 2026-08-14 - Pure Bash lightweight web server.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,157 | 🐛 42 | 🌐 Shell | 📅 2026-08-13 - A simple and extensible shell script for managing your todo.txt file.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,982 | 🐛 97 | 🌐 Go | 📅 2026-08-13 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,378 | 🐛 8 | 🌐 Shell | 📅 2026-08-05 - 750+ DevOps Shell Scripts and Advanced Bash environment.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 4 | 🌐 Shell | 📅 2026-08-16 - A simple testing library for bash scripts.
...
* [Bash Screensavers](https://github.com/attogram/bash-screensavers?) ⭐ 946 | 🐛 11 | 🌐 Shell | 📅 2026-07-23 - A collection of screensavers written entirely in bash.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,198 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,609 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02.
