...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,436 | 🐛 184 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,913 | 🐛 6 | 🌐 Shell | 📅 2026-08-08 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,044 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,094 | 🐛 100 | 📅 2026-06-30.
...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,081 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,629 | 🐛 135 | 🌐 Rust | 📅 2026-08-10 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,605 | 🐛 82 | 🌐 Shell | 📅 2026-08-11 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,635 | 🐛 170 | 🌐 Shell | 📅 2026-08-01 - A delightful community-driven framework for managing your bash configuration.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 898 | 🐛 9 | 🌐 Shell | 📅 2025-09-06 - Modern web framework in bash.
* [balls](https://github.com/jneen/balls) ⭐ 869 | 🐛 5 | 🌐 Shell | 📅 2016-07-29 - Bash on Balls.
* [sherver](https://github.com/remileduc/sherver) ⭐ 351 | 🐛 2 | 🌐 Shell | 📅 2026-08-09 - Pure Bash lightweight web server.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,155 | 🐛 43 | 🌐 Shell | 📅 2026-08-07 - A simple and extensible shell script for managing your todo.txt file.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,973 | 🐛 98 | 🌐 Go | 📅 2026-08-11 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,374 | 🐛 9 | 🌐 Shell | 📅 2026-08-05 - 750+ DevOps Shell Scripts and Advanced Bash environment.
...
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,209 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 3 | 🌐 Shell | 📅 2026-08-13 - A simple testing library for bash scripts.
