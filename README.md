...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,662 | 🐛 187 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 18,026 | 🐛 6 | 🌐 Shell | 📅 2026-09-19 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,078 | 🐛 17 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 509,168 | 🐛 106 | 📅 2026-09-02.
...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,086 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,806 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,658 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,753 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 626 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for the bash shell.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 362 | 🐛 0 | 🌐 Shell | 📅 2026-09-23 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,712 | 🐛 162 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [LS\_COLORS](https://github.com/trapd00r/LS_COLORS) ⭐ 2,276 | 🐛 8 | 🌐 Shell | 📅 2025-06-06 - A collection of LS\_COLORS definitions.
...
* [aphrodite-terminal-theme](https://github.com/win0err/aphrodite-terminal-theme) ⭐ 175 | 🐛 2 | 🌐 Shell | 📅 2025-08-04 - Minimalistic theme (prompt) for sexy terminals.
...
* [Bash-web-server](https://github.com/dzove855/Bash-web-server) ⭐ 997 | 🐛 5 | 🌐 Shell | 📅 2024-02-29 - A purely bash web server, no socat, netcat, etc.
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 916 | 🐛 9 | 🌐 Shell | 📅 2026-09-07 - Modern web framework in bash.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,176 | 🐛 42 | 🌐 Shell | 📅 2026-09-06 - A simple and extensible shell script for managing your todo.txt file.
...
* [Bash One-Liners](http://www.bashoneliners.com/) -  A collection of practical or just pure awesome bash one-liners ([repos](https://github.com/janosgyerik/bashoneliners) ⭐ 223 | 🐛 3 | 🌐 Python | 📅 2025-02-01 by @[janosgyerik](https://github.com/janosgyerik)).
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,240 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework.
* [homeshick](https://github.com/andsens/homeshick) ⭐ 2,193 | 🐛 17 | 🌐 Shell | 📅 2026-08-28 - Git dotfile synchronizer written in Bash.
* [bpkg](https://github.com/bpkg/bpkg) ⭐ 1,975 | 🐛 38 | 🌐 Shell | 📅 2025-07-07 - A lightweight bash package manager.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,079 | 🐛 93 | 🌐 Go | 📅 2026-09-22 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,417 | 🐛 8 | 🌐 Shell | 📅 2026-09-15 - 750+ DevOps Shell Scripts and Advanced Bash environment.
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,277 | 🐛 120 | 🌐 Shell | 📅 2026-09-23 - Bash Automated Testing System.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,453 | 🐛 2 | 🌐 Ruby | 📅 2026-08-24 - Bash command line framework and CLI generator.
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,215 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [modernish](https://github.com/modernish/modernish) ⭐ 941 | 🐛 8 | 🌐 Shell | 📅 2026-08-06 - Library with various features for shell scripting.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 430 | 🐛 0 | 🌐 Shell | 📅 2026-09-23 - A simple testing library for bash scripts.
...
* [Bash Screensavers](https://github.com/attogram/bash-screensavers?) ⭐ 952 | 🐛 11 | 🌐 Shell | 📅 2026-07-23 - A collection of screensavers written entirely in bash.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,212 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,682 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02.
