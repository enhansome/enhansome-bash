...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,087 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,670 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,758 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 362 | 🐛 0 | 🌐 Shell | 📅 2026-09-24 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,714 | 🐛 162 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,245 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,083 | 🐛 93 | 🌐 Go | 📅 2026-09-22 - Format bash programs.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 430 | 🐛 0 | 🌐 Shell | 📅 2026-09-24 - A simple testing library for bash scripts.
