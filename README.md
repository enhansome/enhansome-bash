...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,472 | 🐛 183 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,950 | 🐛 7 | 🌐 Shell | 📅 2026-08-16 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,052 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 498,340 | 🐛 105 | 📅 2026-08-18.
...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,077 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,798 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,751 | 🐛 138 | 🌐 Rust | 📅 2026-08-19 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,633 | 🐛 83 | 🌐 Shell | 📅 2026-08-18 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,305 | 🐛 26 | 🌐 Python | 📅 2026-04-15 - Bash history in the cloud. Indexed and searchable :cloud:.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 623 | 🐛 16 | 🌐 Rust | 📅 2024-10-28 - Contextual, dynamic, organized aliases for the bash shell.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 360 | 🐛 0 | 🌐 Shell | 📅 2026-08-21 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,651 | 🐛 170 | 🌐 Shell | 📅 2026-08-01 - A delightful community-driven framework for managing your bash configuration.
...
* [LS\_COLORS](https://github.com/trapd00r/LS_COLORS) ⭐ 2,274 | 🐛 8 | 🌐 Shell | 📅 2025-06-06 - A collection of LS\_COLORS definitions.
...
* [Bash-web-server](https://github.com/dzove855/Bash-web-server) ⭐ 999 | 🐛 5 | 🌐 Shell | 📅 2024-02-29 - A purely bash web server, no socat, netcat, etc.
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 901 | 🐛 9 | 🌐 Shell | 📅 2025-09-06 - Modern web framework in bash.
* [balls](https://github.com/jneen/balls) ⭐ 869 | 🐛 5 | 🌐 Shell | 📅 2016-07-29 - Bash on Balls.
* [sherver](https://github.com/remileduc/sherver) ⭐ 352 | 🐛 2 | 🌐 Shell | 📅 2026-08-19 - Pure Bash lightweight web server.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,157 | 🐛 43 | 🌐 Shell | 📅 2026-08-13 - A simple and extensible shell script for managing your todo.txt file.
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,143 | 🐛 5 | 🌐 Shell | 📅 2026-08-09 - A community Bash framework.
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,905 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - A static analysis tool for shell scripts.
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,995 | 🐛 99 | 🌐 Go | 📅 2026-08-20 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,382 | 🐛 8 | 🌐 Shell | 📅 2026-08-19 - 750+ DevOps Shell Scripts and Advanced Bash environment.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,435 | 🐛 1 | 🌐 Ruby | 📅 2026-08-20 - Bash command line framework and CLI generator.
...
* [json.bash](https://github.com/h4l/json.bash) ⭐ 461 | 🐛 1 | 🌐 Shell | 📅 2024-12-08 - Bash library and command-line tool that creates JSON.
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 5 | 🌐 Shell | 📅 2026-08-21 - A simple testing library for bash scripts.
