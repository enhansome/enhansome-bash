...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,569 | 🐛 184 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 17,995 | 🐛 7 | 🌐 Shell | 📅 2026-09-06 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,069 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 503,423 | 🐛 106 | 📅 2026-09-02.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,185 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,676 | 🐛 84 | 🌐 Shell | 📅 2026-09-06 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,682 | 🐛 160 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [bocker](https://github.com/p8952/bocker) ⭐ 12,674 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 909 | 🐛 9 | 🌐 Shell | 📅 2025-09-06 - Modern web framework in bash.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,040 | 🐛 93 | 🌐 Go | 📅 2026-09-04 - Format bash programs.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 2 | 🌐 Shell | 📅 2026-09-06 - A simple testing library for bash scripts.
