...
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,807 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,702 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,769 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 628 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for the bash shell.
...
* [todo.sh](https://github.com/todotxt/todo.txt-cli) ⭐ 6,179 | 🐛 43 | 🌐 Shell | 📅 2026-09-06 - A simple and extensible shell script for managing your todo.txt file.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,087 | 🐛 95 | 🌐 Go | 📅 2026-09-22 - Format bash programs.
...
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,284 | 🐛 119 | 🌐 Shell | 📅 2026-09-26 - Bash Automated Testing System.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,454 | 🐛 3 | 🌐 Ruby | 📅 2026-09-26 - Bash command line framework and CLI generator.
...
* [modernish](https://github.com/modernish/modernish) ⭐ 943 | 🐛 8 | 🌐 Shell | 📅 2026-08-06 - Library with various features for shell scripting.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 432 | 🐛 0 | 🌐 Shell | 📅 2026-09-26 - A simple testing library for bash scripts.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,214 | 🐛 28 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,687 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
