...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,627 | 🐛 186 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 18,009 | 🐛 7 | 🌐 Shell | 📅 2026-09-06 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,074 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 506,535 | 🐛 106 | 📅 2026-09-02.
...
* [Safe ways to do things in bash](https://github.com/anordal/shellharden/blob/master/how_to_do_things_safely_in_bash.md) ⭐ 4,805 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - How to do things safely in Bash.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,498 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,731 | 🐛 84 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 361 | 🐛 1 | 🌐 Shell | 📅 2026-09-16 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,708 | 🐛 161 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,059 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - Format bash programs.
...
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,262 | 🐛 125 | 🌐 Shell | 📅 2026-09-15 - Bash Automated Testing System.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,805 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 - The corrective bash syntax highlighter.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 427 | 🐛 0 | 🌐 Shell | 📅 2026-09-16 - A simple testing library for bash scripts.
...
* [Bash Screensavers](https://github.com/attogram/bash-screensavers?) ⭐ 951 | 🐛 11 | 🌐 Shell | 📅 2026-07-23 - A collection of screensavers written entirely in bash.
