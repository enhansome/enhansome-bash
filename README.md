...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,999 | 🐛 139 | 🌐 Rust | 📅 2026-08-28 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,305 | 🐛 26 | 🌐 Python | 📅 2026-08-28 - Bash history in the cloud. Indexed and searchable :cloud:.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 360 | 🐛 0 | 🌐 Shell | 📅 2026-08-28 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 905 | 🐛 9 | 🌐 Shell | 📅 2025-09-06 - Modern web framework in bash.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,020 | 🐛 97 | 🌐 Go | 📅 2026-08-28 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,390 | 🐛 8 | 🌐 Shell | 📅 2026-08-24 - 750+ DevOps Shell Scripts and Advanced Bash environment.
