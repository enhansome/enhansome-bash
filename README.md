...
In addition to this list, you should read the list [awesome-shell](https://github.com/alebcay/awesome-shell) ⭐ 37,642 | 🐛 186 | 📅 2025-08-28. It is a curated list of awesome command-line frameworks, toolkits, guides and gizmos. You may also want to check [awesome-zsh](https://github.com/unixorn/awesome-zsh-plugins) ⭐ 18,017 | 🐛 7 | 🌐 Shell | 📅 2026-09-16 or [awesome-fish](https://github.com/bucaran/awesome-fish) ⭐ 5,076 | 🐛 16 | 📅 2026-01-25. If you are looking for more lists, check [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 507,648 | 🐛 106 | 📅 2026-09-02.
...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,085 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,568 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,746 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,307 | 🐛 24 | 🌐 Python | 📅 2026-08-30 - Bash history in the cloud. Indexed and searchable :cloud:.
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 625 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for the bash shell.
...
* [forkrun](https://github.com/jkool702/forkrun) ⭐ 361 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - A pure-bash tool for running code in parallel. Similar in syntax and speed to `xargs -P`, but with more features and native Bash function support.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,711 | 🐛 161 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [bash-sensible](https://github.com/mrzool/bash-sensible) ⭐ 2,125 | 🐛 10 | 🌐 Shell | 📅 2024-10-17 - An attempt at saner Bash defaults.
...
* [bash-stack](https://github.com/cgsdev0/bash-stack) ⭐ 914 | 🐛 9 | 🌐 Shell | 📅 2026-09-07 - Modern web framework in bash.
* [balls](https://github.com/jneen/balls) ⭐ 868 | 🐛 5 | 🌐 Shell | 📅 2016-07-29 - Bash on Balls.
* [sherver](https://github.com/remileduc/sherver) ⭐ 353 | 🐛 3 | 🌐 Shell | 📅 2026-09-15 - Pure Bash lightweight web server.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,065 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,411 | 🐛 8 | 🌐 Shell | 📅 2026-09-15 - 750+ DevOps Shell Scripts and Advanced Bash environment.
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,269 | 🐛 129 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System.
...
* [bashly](https://github.com/DannyBen/bashly) ⭐ 2,450 | 🐛 2 | 🌐 Ruby | 📅 2026-08-24 - Bash command line framework and CLI generator.
* [bash3boilerplate](https://github.com/kvz/bash3boilerplate) ⭐ 2,216 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Templates to write better Bash scripts.
...
* [modernish](https://github.com/modernish/modernish) ⭐ 939 | 🐛 8 | 🌐 Shell | 📅 2026-08-06 - Library with various features for shell scripting.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 430 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - A simple testing library for bash scripts.
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,208 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,680 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
