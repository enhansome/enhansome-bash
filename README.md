...
* [bash-handbook](https://github.com/denysdovhan/bash-handbook) ⭐ 6,082 | 🐛 30 | 🌐 JavaScript | 📅 2024-02-05 - A handbook for those who want to learn Bash without diving in too deeply.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,248 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,692 | 🐛 85 | 🌐 Shell | 📅 2026-09-07 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,687 | 🐛 160 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,043 | 🐛 93 | 🌐 Go | 📅 2026-09-07 - Format bash programs.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 0 | 🌐 Shell | 📅 2026-09-08 - A simple testing library for bash scripts.
