...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,302 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,706 | 🐛 84 | 🌐 Shell | 📅 2026-09-08 - User-friendly and feature rich readline replacement, with syntax highlighting, better command completion, and improved multi-line editing.
...
* [oh-my-bash](https://github.com/ohmybash/oh-my-bash) ⭐ 7,690 | 🐛 160 | 🌐 Shell | 📅 2026-09-02 - A delightful community-driven framework for managing your bash configuration.
...
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,046 | 🐛 93 | 🌐 Go | 📅 2026-09-07 - Format bash programs.
* [DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools) ⭐ 8,399 | 🐛 8 | 🌐 Shell | 📅 2026-09-04 - 750+ DevOps Shell Scripts and Advanced Bash environment.
...
* [bashunit](https://github.com/TypedDevs/bashunit) ⭐ 424 | 🐛 6 | 🌐 Shell | 📅 2026-09-09 - A simple testing library for bash scripts.
